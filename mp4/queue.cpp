 ...
 * caller.You may assume that this function is only called
...
T Queue<T>::dequeue()
{
     ...
     */
    //if (outStack.isEmpty() && inStack.isEmpty()) return;
 ...
 * caller. Unlike pop(), this operation does not alter the queue. You may assume that this function is only called when the
 * Queue is non-empty.
 *
